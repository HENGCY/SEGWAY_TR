...
/* Fonction appelee periodiquement, qui actualise la valeur de l'angle */
gboolean update_angle(GtkWidget *widget);

/* Fonction appelee periodiquement, qui actualise la valeur de la vitesse angulaire*/
gboolean update_vit_ang(GtkWidget *widget);

/* Fonction appelee periodiquement, qui actualise la valeur de la vitesse lineaire */
gboolean update_vit_lin(GtkWidget *widget);

/* Fonction appelee periodiquement, qui actualise la valeur de la consigne de couple */
gboolean update_couple(GtkWidget *widget);

/* Fonction appelee periodiquement, qui actualise la valeur du niveau de batterie*/
gboolean update_bat_lvl(GtkWidget *widget);

/* Fonction appelee periodiquement, qui actualise le contenu du log */
...
/* Fonction appelée periodiquement, qui fait tous les tâches */
