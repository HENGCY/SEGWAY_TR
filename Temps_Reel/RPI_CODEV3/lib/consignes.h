...
#include "constantes.h"
    ...
    typedef struct Consignes {
        ...
        void(*set_moteur1) (struct Consignes *This, float C1);    /*!< Appel à la fonction Consignes_set_moteur1(). */
        void(*set_moteur2) (struct Consignes *This, float C2);    /*!< Appel à la fonction Consignes_set_moteur2(). */
    ...
    /**
     * \fn void consignes_set_moteur1(Consignes *This, float C1)
     * \brief Mise à jour du comsignes de commandes de moteurs décrit par un objet Consignes.
     * \param This Auto-adressage de l'objet auquel changer la valeur.
     * \param C1  Nouvelle valeur de consigne M1
    */
    void consignes_set_moteur1(Consignes *This, float C1 );

    /**
     * \fn void consignes_set_moteur2(Consignes *This, float C2);
     * \brief Mise à jour du comsignes de commandes de moteurs décrit par un objet Consignes.
     * \param This Auto-adressage de l'objet auquel changer la valeur.
     * \param C2  Nouvelle valeur de consigne M2
    */
    void consignes_set_moteur2(Consignes *This, float C2);
